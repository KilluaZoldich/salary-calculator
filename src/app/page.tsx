...
import { ChevronDown, ChevronUp, Calculator, Clock, Sun, Moon, Euro, Car, Coffee, Phone, RefreshCw } from 'lucide-react'
                      ...
                      {week.map((day, dayIndex) => (
                        <AccordionItem key={dayIndex} value={`day-${dayIndex}`}>
                          <AccordionTrigger className="flex justify-between items-center hover:bg-gray-100 dark:hover:bg-gray-700 transition-colors duration-200 p-4 rounded-lg">
                            <span className="font-medium w-32 text-left">{days[dayIndex]}</span>
                          ...
                          <AccordionContent>
                            {day.presenza && (
                              <div className="grid grid-cols-1 sm:grid-cols-2 gap-4 pt-4">
                                <div className="flex items-center space-x-2">
                                  <Label htmlFor={`guida-${weekIndex}-${dayIndex}`} className="text-gray-700 dark:text-gray-300 w-24">Guida</Label>
                                  <Switch
                                ...
                                <div className="flex items-center space-x-2">
                                  <Label htmlFor={`reperibilita-${weekIndex}-${dayIndex}`} className="text-gray-700 dark:text-gray-300 w-24">Reperibilità</Label>
                                  <Switch
                                ...
                                <div className="flex items-center space-x-2">
                                  <Label htmlFor={`ffCena-${weekIndex}-${dayIndex}`} className="text-gray-700 dark:text-gray-300 w-24">FF Cena</Label>
                                  <Switch
                                ...
                                <div className="flex items-center space-x-2">
                                  <Label htmlFor={`extraFF-${weekIndex}-${dayIndex}`} className="text-gray-700 dark:text-gray-300 w-24">E/F</Label>
                                  <select
                                ...
                                {['Diurno', 'Notturno', 'Festivo'].map((tipo) => (
                                  <div key={tipo} className="col-span-2 flex items-center space-x-2">
                                    ...
                                    <Label className="text-gray-700 dark:text-gray-300 w-24">Str. {tipo}</Label>
                                    <Input
                                      type="number"
                                      placeholder="Ore"
